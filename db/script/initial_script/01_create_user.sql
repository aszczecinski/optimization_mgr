...
CREATE USER "&&SCHEMA_NAME" identified by "&&SCHEMA_PASSWORD" profile default default tablespace "&&SCHEMA_PASSWORD" account unlock;
ALTER USER "&&SCHEMA_NAME" QUOTA UNLIMITED ON "&&SCHEMA_PASSWORD";
